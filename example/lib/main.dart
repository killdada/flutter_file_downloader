...
class _MyHomePageState extends State<MyHomePage> with WidgetsBindingObserver {
  ...
  final _videos = [
    ...
    },
    {
      'name': 'Elephant Dream',
      'link':
          'http://peiban-test.mypaas.com.cn/e1fdd74c4ee4971ed7ca231f9b657d96?e=1569492336&token=LpNTKHe9PCPaA6XrPvc61qks-CQka7ma4SPUlJj-:CSlAc8pbvXT14U845y8LhfFg3oE='
    }
  ];
  ...
  void initState() {
    ...
    FlutterDownloader.registerCallback((id, status, progress, speed) {
      print(
          'Download task ($id) is in status ($status) and process ($progress) and speed (${speed / 1024}kb/s)');
