...
public class TaskDao {
    ...
    public void insertOrUpdateNewTask(String taskId, String url, int status, int progress, String fileName,
                                      String savedDir, String headers, String extra, boolean showNotification, boolean openFileFromNotification) {
        ...
        values.put(TaskContract.TaskEntry.COLUMN_NAME_EXTRA, extra);
    ...
    private DownloadTask parseCursor(Cursor cursor) {
        ...
        return new DownloadTask(primaryId, taskId, status, progress, url, filename, savedDir, headers, extra,
